namespace QuickGraph
{
    ...
    /// <summary>Extension methods for populating graph datastructures</summary>
    public static class GraphExtensions
    {
        /// <summary>Converts a jagged array of sources and targets into a graph</summary>
        ...
        /// <summary>Converts a set of edges into an adjacency graph.</summary>
        ...
        /// <summary>Converts a set of vertices into an adjacency graph, using an edge factory.</summary>
        /// <typeparam name="TVertex">The type of the vertex.</typeparam>
        /// <typeparam name="TEdge">The type of the edge.</typeparam>
        ...
        /// <summary>Converts a sequence of vertex pairs into an adjancency graph</summary>
        ...
        /// <summary>Creates an immutable array adjacency graph from the input graph</summary>
        /// <typeparam name="TVertex">type of the vertices</typeparam>
        ...
        /// <summary>Creates an immutable array bidirectional graph from the input graph</summary>
        /// <typeparam name="TVertex">type of the vertices</typeparam>
        /// <typeparam name="TEdge">type of the edges</typeparam>
        /// <param name="graph"></param>
        /// <returns></returns>
        ...
        /// <summary>Creates an immutable array undirected graph from the input graph</summary>
        /// <typeparam name="TVertex">type of the vertices</typeparam>
        /// <typeparam name="TEdge">type of the edges</typeparam>
        /// <param name="graph"></param>
        /// <returns></returns>
        ...
        /// <summary>Wraps a adjacency graph (out-edge only) into a bidirectional graph.</summary>
        /// <typeparam name="TVertex">type of the vertices</typeparam>
        /// <typeparam name="TEdge">type of the edges</typeparam>
        /// <param name="graph"></param>
        /// <returns></returns>
        ...
        /// <summary>Converts a set of edges into a bidirectional graph.</summary>
        /// <typeparam name="TVertex">The type of the vertex.</typeparam>
        /// <typeparam name="TEdge">The type of the edge.</typeparam>
        /// <param name="edges">The edges.</param>
        /// <param name="allowParallelEdges">if set to <c>true</c>, the graph allows parallel edges.</param>
        ...
        /// <summary>Converts a set of vertices into a bidirectional graph, using an edge factory.</summary>
        /// <typeparam name="TVertex">The type of the vertex.</typeparam>
        /// <typeparam name="TEdge">The type of the edge.</typeparam>
        /// <param name="vertices">The vertices.</param>
        /// <param name="outEdgesFactory">The out edges factory.</param>
        ...
        /// <summary>Converts a sequence of vertex pairs into an bidirectional graph</summary>
        /// <typeparam name="TVertex">type of the vertices</typeparam>
        /// <param name="vertexPairs"></param>
        /// <returns></returns>
        ...
        /// <summary>Creates an immutable compressed row graph representation of the visited graph</summary>
        /// <typeparam name="TVertex">type of the vertices</typeparam>
        /// <typeparam name="TEdge">type of the edges</typeparam>
        ...
        /// <summary>Creates an instance of DelegateIncidenceGraph.</summary>
        /// <typeparam name="TVertex">type of the vertices</typeparam>
        /// <typeparam name="TEdge">type of the edges</typeparam>
        /// <param name="tryGetOutEdges"></param>
        /// <param name="tryGetInEdges"></param>
        /// <returns></returns>
        public static DelegateBidirectionalIncidenceGraph<TVertex, TEdge> ToDelegateBidirectionalIncidenceGraph
            <TVertex, TEdge>(
                this
        ...
        /// <summary>Wraps a dictionary into an undirected list graph</summary>
        /// <typeparam name="TVertex">type of the vertices</typeparam>
        /// <typeparam name="TEdge">type of the edges</typeparam>
        ...
        /// <summary>Wraps a dictionary into an undirected graph</summary>
        /// <typeparam name="TVertex">type of the vertices</typeparam>
        /// <typeparam name="TEdge">type of the edges</typeparam>
        /// <typeparam name="TValue"></typeparam>
        /// <param name="dictionary"></param>
        ...
        /// <summary>Converts a Func that returns a reference type into a tryfunc</summary>
        ...
        /// <summary>Converts a sequence of edges into an undirected graph</summary>
        /// <typeparam name="TVertex">type of the vertices</typeparam>
        /// <typeparam name="TEdge">type of the edges</typeparam>
        /// <param name="edges"></param>
        /// <returns></returns>
        ...
        /// <summary>Wraps a dictionary into a vertex and edge list graph</summary>
        /// <typeparam name="TVertex">type of the vertices</typeparam>
        /// <typeparam name="TEdge">type of the edges</typeparam>
        /// <typeparam name="TValue"></typeparam>
        /// <param name="dictionary"></param>
