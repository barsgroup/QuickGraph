namespace QuickGraph
{
    ...
    /// <summary>
    ///     A mutable directed graph data structure efficient for sparse graph representation where out-edge and in-edges
    ///     need to be enumerated. Requires twice as much memory as the adjacency graph.
    /// </summary>
        ...
        where TEdge : IEdge<TVertex>
    {
        ...
        public bool TryGetInEdges(TVertex v, out IEnumerable<TEdge> edges)
        {
            ...
            if (_vertexInEdges.TryGetValue(v, out list))
            {
                edges = list;
                return true;
            }
        ...
        {
            IEdgeList<TVertex, TEdge> list;
            if (_vertexOutEdges.TryGetValue(v, out list))
            {
                edges = list;
                return true;
            }
            ...
            out TEdge edge)
        {
            ...
            if (_vertexOutEdges.TryGetValue(source, out edgeList) &&
                edgeList.Count > 0)
            {
        ...
        public bool ContainsEdge(TEdge edge)
        {
            ...
            return _vertexOutEdges.TryGetValue(edge.Source, out outEdges) &&
