namespace QuickGraph
{
    ...
    public static class EdgeExtensions
    {
        ...
        /// <summary>Given a source vertex, returns the other vertex in the edge</summary>
        ...
        /// <summary>
        ///     Returns the most efficient comporer for the particular type of TEdge. If TEdge implements IUndirectedEdge,
        ///     then only the (source,target) pair has to be compared; if not, (source, target) and (target, source) have to be
        ///     compared.
        /// </summary>
        /// <typeparam name="TVertex">type of the vertices</typeparam>
        /// <typeparam name="TEdge">type of the edges</typeparam>
            ...
            where TEdge : IEdge<TVertex>
        {
            ...
            Contract.Requires(typeof(TEdge).GetTypeInfo().IsValueType || path.All(e => e != null));
        ...
        /// <summary>Gets a value indicating if <paramref name="vertex" /> is adjacent to <paramref name="edge" />
        ///     (is the source or target).</summary>
        /// <typeparam name="TVertex">type of the vertices</typeparam>
        /// <typeparam name="TEdge">type of the edges</typeparam>
        ...
        /// <summary>Checks that <paramref name="root" /> is a predecessor of <paramref name="vertex" />
        /// </summary>
        /// <typeparam name="TVertex">type of the vertices</typeparam>
        /// <typeparam name="TEdge">type of the edges</typeparam>
        ...
        /// <summary>Gets a value indicating if the edge is a self edge.</summary>
        /// <typeparam name="TVertex">type of the vertices</typeparam>
        /// <typeparam name="TEdge">type of the edges</typeparam>
        /// <param name="edge"></param>
        /// <returns></returns>
        ...
        /// <summary>Returns a reversed edge enumeration</summary>
        ...
        /// <summary>Gets a value indicating if the vertices of edge match (source, target)</summary>
        /// <typeparam name="TVertex">type of the vertices</typeparam>
        /// <typeparam name="TEdge">type of the edges</typeparam>
        /// <param name="edge"></param>
        ...
        /// <summary>Creates a vertex pair (source, target) from the edge</summary>
        /// <typeparam name="TVertex">type of the vertices</typeparam>
        /// <typeparam name="TEdge">type of the edges</typeparam>
        /// <param name="edge"></param>
        /// <returns></returns>
        ...
        /// <summary>Gets a value indicating if the vertices of edge match (source, target) or (target, source)</summary>
        /// <typeparam name="TVertex">type of the vertices</typeparam>
        /// <typeparam name="TEdge">type of the edges</typeparam>
        /// <param name="edge"></param>
        /// <param name="source"></param>
