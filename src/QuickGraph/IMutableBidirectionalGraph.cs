namespace QuickGraph
{
    ...
    /// <summary>A mutable bidirectional directed graph</summary>
    ...
    {
        /// <summary>Clears in-edges and out-edges of <paramref name="v" />
        /// </summary>
        /// <param name="v"></param>
        void ClearEdges(TVertex v);

        /// <summary>Clears in-edges of <paramref name="v" />
        /// </summary>
        /// <param name="v"></param>
        void ClearInEdges(TVertex v);

        /// <summary>Removes in-edges of <paramref name="v" /> that match predicate <paramref name="edgePredicate" />.</summary>
        /// <param name="v"></param>
