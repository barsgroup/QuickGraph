namespace QuickGraph
{
        ...
        where TEdge : IEdge<TVertex>
    {
        ...
        /// <summary>Gets the number of in-edges of <paramref name="v" />
        /// </summary>
        /// <param name="v">The vertex.</param>
        ...
        /// <summary>Gets the collection of in-edges of <paramref name="v" />.</summary>
        /// <param name="v">The vertex</param>
        /// <returns>The collection of in-edges of <paramref name="v" /></returns>
        [Pure]
        IEnumerable<TEdge> InEdges(TVertex v);

        /// <summary>Determines whether <paramref name="v" /> has no in-edges.</summary>
        /// <param name="v">The vertex</param>
        /// <returns>
        ...
        /// <summary>Tries to get the in-edges of <paramref name="v" />
        /// </summary>
        /// <param name="v"></param>
