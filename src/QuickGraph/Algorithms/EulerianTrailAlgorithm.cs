namespace QuickGraph.Algorithms
{
    ...
    {
        private readonly List<TEdge> _temporaryCircuit;
        ...
        /// <summary>Construct an eulerian trail builder</summary>
        ...
        /// <summary>Computes the number of eulerian trail in the graph.</summary>
        /// <param name="g"></param>
        ...
        /// <remarks>This method returns a set of disjoint eulerian trails. This set of trails spans the entire set of edges.</remarks>
        ...
        ///     </para>
        ///     <para>
        ///         The algorithms iterates throught the Eulerian circuit of the augmented graph (the augmented graph is the
        ///         graph with additional edges to make the number of odd vertices even).
        ///     </para>
        ///     <para>If the current edge is not temporary, it is added to the current trail.</para>
        ///     <para>
        ///         If the current edge is temporary, the current trail is finished and added to the trail collection. The
        ///         shortest path between the start vertex <paramref name="s" /> and the target vertex of the temporary edge is
        ///         then used to start the new trail. This shortest path is computed using the BreadthFirstSearchAlgorithm.
        ///     </para>
        /// </remarks>
