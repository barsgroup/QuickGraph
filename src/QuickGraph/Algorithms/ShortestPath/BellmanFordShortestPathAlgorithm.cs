namespace QuickGraph.Algorithms.ShortestPath
{
    ...
    /// <remarks>
    ///     <para>
    ///         The Bellman-Ford algorithm solves the single-source shortest paths problem for a graph with both positive and
    ///         negative edge weights.
    ///     </para>
    ///     <para>
    ///         If you only need to solve the shortest paths problem for positive edge weights, Dijkstra's algorithm provides
    ///         a more efficient alternative.
    ///     </para>
    ///     <para>
    ///         If all the edge weights are all equal to one then breadth-first search provides an even more efficient
    ///         alternative.
    ///     </para>
    /// </remarks>
    /// <reference-ref
        ...
        where TEdge : IEdge<TVertex>
    {
        ...
        /// <summary>Indicates if a negative cycle was found</summary>
        public bool FoundNegativeCycle { get; private set; }

        /// <summary>Constructed predecessor map</summary>
        public IDictionary<TVertex, TVertex> Predecessors => _predecessors;
        ...
        /// <remarks>Does not initialize the predecessor and distance map.</remarks>
        ...
        /// <summary>Raises the <see cref="EdgeMinimized" /> event.</summary>
        ...
        /// <summary>Raises the <see cref="EdgeNotMinimized" /> event.</summary>
        /// <param name="e">edge that raised the event</param>
        ...
        /// <summary>Raises the <see cref="EdgeNotRelaxed" /> event.</summary>
        /// <param name="e">edge that raised the event</param>
        ...
        /// <summary>Raises the <see cref="InitializeVertex" /> event.</summary>
        ...
        /// <summary>
        ///     Invoked during the second stage of the algorithm, during the test of whether each edge was minimized. If the
        ///     edge is minimized then this function is invoked.
        /// </summary>
        public event EdgeAction<TVertex, TEdge> EdgeMinimized;

        /// <summary>
        ///     Invoked during the second stage of the algorithm, during the test of whether each edge was minimized. If the
        ///     edge was not minimized, this function is invoked. This happens when there is a negative cycle in the graph.
        /// </summary>
