namespace QuickGraph.Algorithms
{
    ...
    /// <summary>Various extension methods to build algorithms</summary>
    public static class AlgorithmExtensions
    {
        /// <summary>Clones a graph to another graph</summary>
        ...
        /// <summary>Given a edge cost map, computes the predecessor cost.</summary>
        /// <typeparam name="TVertex">type of the vertices</typeparam>
        /// <typeparam name="TEdge">type of the edges</typeparam>
        ...
        /// <summary>Condensates the weakly connected components of a graph</summary>
        /// <typeparam name="TVertex">type of the vertices</typeparam>
        /// <typeparam name="TEdge">type of the edges</typeparam>
        /// <typeparam name="TGraph"></typeparam>
        /// <param name="g"></param>
        ...
        /// <summary>Computes the connected components of a graph</summary>
        /// <typeparam name="TVertex">type of the vertices</typeparam>
        /// <typeparam name="TEdge">type of the edges</typeparam>
        /// <param name="g"></param>
        ...
        /// <summary>Gets the edge identity.</summary>
        ...
        /// <remarks>Returns more efficient methods for primitive types, otherwise builds a dictionary</remarks>
        /// <typeparam name="TVertex">The type of the vertex.</typeparam>
        /// <param name="graph">The graph.</param>
        /// <returns></returns>
        ...
        /// <summary>
        ///     Computes the incremental connected components for a growing graph (edge added only). Each call to the delegate
        ///     re-computes the component dictionary. The returned dictionary is shared accross multiple calls of the method.
        /// </summary>
        /// <typeparam name="TVertex">type of the vertices</typeparam>
        /// <typeparam name="TEdge">type of the edges</typeparam>
        /// <param name="g"></param>
        ...
        /// <summary>Gets a value indicating whether the graph is acyclic</summary>
        /// <remarks>Performs a depth first search to look for cycles.</remarks>
        /// <typeparam name="TVertex">type of the vertices</typeparam>
        /// <typeparam name="TEdge">type of the edges</typeparam>
        /// <param name="g"></param>
        /// <returns></returns>
        ...
        /// <summary>Gets the list of isolated vertices (no incoming or outcoming vertices)</summary>
        /// <typeparam name="TVertex">type of the vertices</typeparam>
        /// <typeparam name="TEdge">type of the edges</typeparam>
        ...
        /// <summary>Computes the Edmonds-Karp maximums flow for a graph with positive capacities and flows.</summary>
        /// <typeparam name="TVertex">The type of the vertex.</typeparam>
        /// <typeparam name="TEdge">The type of the edge.</typeparam>
        ...
        /// <summary>Computes the minimum spanning tree using Kruskal's algorithm.</summary>
        /// <typeparam name="TVertex">type of the vertices</typeparam>
        /// <typeparam name="TEdge">type of the edges</typeparam>
        /// <param name="visitedGraph"></param>
        ...
        /// <summary>
        ///     Computes the minimum spanning tree using Prim's algorithm. Prim's algorithm is simply implemented by calling
            ...
            where TEdge : IEdge<TVertex>
        {
            ...
            return
                delegate(SEquatableEdge<TVertex> pair, out TVertex value)
                {
        ...
        /// <summary>Computes the k-shortest path from <paramref name="source" />
        ///     <paramref name="target" /> using Hoffman-Pavley algorithm.</summary>
        /// <typeparam name="TVertex">type of the vertices</typeparam>
        /// <typeparam name="TEdge">type of the edges</typeparam>
        /// <param name="visitedGraph"></param>
        ...
        /// <summary>Gets the list of root vertices</summary>
        /// <typeparam name="TVertex">type of the vertices</typeparam>
        /// <typeparam name="TEdge">type of the edges</typeparam>
        /// <param name="visitedGraph"></param>
        /// <returns></returns>
        ...
        /// <summary>Gets the list of sink vertices</summary>
        /// <typeparam name="TVertex">type of the vertices</typeparam>
        /// <typeparam name="TEdge">type of the edges</typeparam>
        /// <param name="visitedGraph"></param>
        /// <returns></returns>
        ...
        /// <summary>Computes the strongly connected components of a graph</summary>
        /// <typeparam name="TVertex">type of the vertices</typeparam>
        /// <typeparam name="TEdge">type of the edges</typeparam>
        /// <param name="g"></param>
        /// <param name="components"></param>
        ...
        /// <summary>Creates a topological sort of a undirected acyclic graph.</summary>
        /// <typeparam name="TVertex">type of the vertices</typeparam>
        /// <typeparam name="TEdge">type of the edges</typeparam>
        /// <param name="visitedGraph"></param>
        /// <returns></returns>
        ...
        /// <summary>Creates a topological sort of a directed acyclic graph.</summary>
        /// <typeparam name="TVertex">type of the vertices</typeparam>
        /// <typeparam name="TEdge">type of the edges</typeparam>
        /// <param name="visitedGraph"></param>
        /// <returns></returns>
        ...
        /// <summary>Computes a depth first tree.</summary>
        /// <typeparam name="TVertex">The type of the vertex.</typeparam>
        /// <typeparam name="TEdge">The type of the edge.</typeparam>
        /// <param name="visitedGraph">The visited graph.</param>
        ...
        /// <summary>Computes the weakly connected components of a graph</summary>
        /// <typeparam name="TVertex">type of the vertices</typeparam>
        /// <typeparam name="TEdge">type of the edges</typeparam>
        /// <param name="g"></param>
        /// <param name="components"></param>
