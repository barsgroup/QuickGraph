namespace QuickGraph
{
    ...
    /// <summary>A mutable edge list graph.</summary>
        ...
        where TEdge : IEdge<TVertex>
    {
        ...
        /// <summary>Raised when an edge is added to the graph.</summary>
        event EdgeAction<TVertex, TEdge> EdgeAdded;

        /// <summary>Raised when an edge has been removed from the graph.</summary>
