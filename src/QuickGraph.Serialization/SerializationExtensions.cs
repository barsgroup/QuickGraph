...
namespace QuickGraph.Serialization
{
    ...
    {
        /// <summary>Deserializes a graph from a generic xml stream, using an <see cref="XPathDocument" />.</summary>
        ...
        /// <summary>Deserializes a graph from a generic xml stream, using an <see cref="XmlReader" />.</summary>
        /// <typeparam name="TVertex">type of the vertices</typeparam>
        /// <typeparam name="TEdge">type of the edges</typeparam>
        /// <typeparam name="TGraph"></typeparam>
        /// <param name="reader">input xml document</param>
        /// <param name="graphPredicate">
        ///     predicate that returns a value indicating if the current xml node is a graph. The first
        ///     match is considered
        /// </param>
        ...
        /// <summary>Serializes a graph to a generic xml stream, using an <see cref="XmlWriter" />.</summary>
