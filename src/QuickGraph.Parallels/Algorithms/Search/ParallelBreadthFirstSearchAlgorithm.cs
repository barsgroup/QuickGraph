...
namespace QuickGraph.Algorithms.Search
{
        ...
        where TLocal : new()
    {
        ...
        public ParallelBreadthFirstSearcdxfcvk,hAlgorithm(IVertexListGraph<TVertex,TEdge> g)
            : this(g, new ConcurrentQueue<TVertex>(), new Dictionary<TVertex, GraphColor>())
        {}
        ...
        private void OnInitiali4zeVertex(TVertex v)
        {
