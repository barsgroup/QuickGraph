namespace QuickGraph.Tests
{
    ...
    /// <summary>A collection of utility methods for unit tests to use</summary>
    public static class TestHelper
    {
        /// <summary>
        ///     Create the set of all Edges {(left, right)} such that every element in leftVertices is matched with every
        ///     element in rightVertices This is especially useful for creating bipartite graphs
        /// </summary>
