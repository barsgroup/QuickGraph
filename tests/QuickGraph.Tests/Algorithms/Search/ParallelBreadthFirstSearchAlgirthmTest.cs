namespace QuickGraph.Algorithms.Search
{
    ...
    public class ParallelBreadthFirstAlgorithmSearchTest
    {
        ...
        {
            Assert.Equal(algo.GetVertexColor(args.Vertex), GraphColor.White);
        }
        ...
        private void ExamineVertex(Object sender, VertexEventArgs<int> args)
        {
            ...
            Assert.True(distances[u] == currentDistance
        ...
        private void DiscoverVertex(Object sender, VertexEventArgs<int> args)
        {
            ...
            Assert.Equal(algo.GetVertexColor(u), GraphColor.Gray);
            if (u != sourceVertex)
            {
        ...
        {
            Assert.Equal(algo.GetVertexColor(args.Vertex), GraphColor.Gray);
        }
