namespace QuickGraph.Algorithms.Search
{
    ...
    public class UndirectedBreadthFirstAlgorithmSearchTest
    {
            ...
            where TEdge : IEdge<TVertex>
        {
            ...
            {
                Assert.True(
                    args.Source.Equals(currentVertex) ||
            ...
            {
                //Assert.Equal(algo.VertexColors[args.Edge.Target], GraphColor.Gray);
            };
            algo.BlackTarget += (sender, args) =>
            {
                //Assert.Equal(algo.VertexColors[args.Edge.Target], GraphColor.Black);
